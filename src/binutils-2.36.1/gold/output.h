 ...
 private:
  ...
  class Got_entry
  {
   public:
    ...
    void
    write(unsigned int got_indx, unsigned char* pov, Layout* my_layout, uint64_t got_offset) const; /// xie
   ...
   private:
    ...
    /// xie
    void write(unsigned int got_indx, unsigned char *pov, Layout *my_layout, uint32_t got_offset) const;
  };
...
class Output_section : public Output_data
{
 public:
  ...
  Output_section(const char* name, elfcpp::Elf_Word, elfcpp::Elf_Xword, Layout* my_layout=NULL); /// xie
  virtual ~Output_section();
  ...
  /// xie: Pointer information recorded in this object file
  ...
  class Input_section
  {
   public:
	...
	this->u2_.posd->print_merge_stats(section_name);
      ...
      /// xie: Record the name of the input_section
