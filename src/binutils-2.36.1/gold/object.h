...
class Sized_relobj_file : public Sized_relobj<size, big_endian>
{
 public:
    /// xie:
    std::map<uint32_t, bool> shndx_map;  // Record the mapping of indexs and section names in obj
    unsigned rand_ndx = 0;               // Record the index of .rand section
    bool has_rand = false;

    std::unordered_map<uint64_t, ShuffleInfo::ReorderInfo_FixupInfo_FixupTuple*> fixup_text_map;
    std::unordered_map<uint64_t, ShuffleInfo::ReorderInfo_FixupInfo_FixupTuple*> fixup_rodata_map;
    std::unordered_map<uint64_t, ShuffleInfo::ReorderInfo_FixupInfo_FixupTuple*> fixup_data_map;
    std::unordered_map<uint64_t, ShuffleInfo::ReorderInfo_FixupInfo_FixupTuple*> fixup_data_rel_map;
    std::unordered_map<uint64_t, ShuffleInfo::ReorderInfo_FixupInfo_FixupTuple*> fixup_init_map;
    std::unordered_map<uint64_t, ShuffleInfo::ReorderInfo_FixupInfo_FixupTuple*> fixup_preinit_map;
    std::unordered_map<uint64_t, ShuffleInfo::ReorderInfo_FixupInfo_FixupTuple*> fixup_fini_map;
  ...
  { return this->is_deferred_layout_; }
    ...
    /// xie
    void set_fixup(ShuffleInfo::ReorderInfo_FixupInfo_FixupTuple *fixup_output,
...
protected:
 ...
 private:
  ...
  write_sections(const Layout*, const unsigned char* pshdrs, Output_file*,
		 Views*, const Symbol_table* symtab); /// xie
